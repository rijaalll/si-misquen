// app/teller/layout.js
// Layout khusus untuk halaman teller.
...
export default function TellerRootLayout({ children }) {
  ...
  return (
    ...
    <ProtectedLayout allowedRoles={['teller']}>
      <div className="flex flex-col min-h-screen bg-gray-50">
        {/* Header/Navbar Section untuk halaman teller */}
        ...
        <main className="flex-grow p-6">
          {children} {/* Merender komponen anak (TellerView) */}
        </main>
