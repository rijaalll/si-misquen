  ...
  return (
    <ProtectedLayout allowedRoles={['admin']}>
      <div className="container mx-auto p-4"> {/* Added container for better spacing */}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4"> {/* Adjusted for responsiveness */}
          <h2 className="text-3xl font-bold text-gray-800 flex items-center gap-2 text-center sm:text-left"> {/* Centered on mobile */}
            <ChartBarIcon className="w-8 h-8 text-purple-600" /> Laporan Keuangan Koperasi
          </h2>
          <button
            onClick={handleExportToExcel}
            className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md shadow-sm transition duration-150 ease-in-out flex items-center gap-1 w-full sm:w-auto justify-center" // Full width on mobile
          >
